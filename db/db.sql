...
INSERT INTO `article` (`id`, `title`, `content`, `user_id`, `date`, `category_id`) VALUES
...
--
ALTER TABLE `article`
  ADD PRIMARY KEY (`id`), ADD KEY `fk_article_user_id_idx` (`user_id`), ADD KEY `fk_article_category_id_idx` (`category_id`);
...
ALTER TABLE `article`
ADD CONSTRAINT `fk_article_category_id` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
